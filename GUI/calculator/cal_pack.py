...
def start():
	...
	e = Entry(root, bg=main_bg, fg=main_fg, font=('Courier New', 35), justify='right')
	e.pack(fill='x', padx=5, pady=5)

	row1 = Frame(root, bg=main_bg)

	b1 = Button(row1, bg=main_bg, fg=main_fg, text='1', font=("Times New Roman", 25), command=lambda: add("1"))
	b1.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b2 = Button(row1, bg=main_bg, fg=main_fg, text='2', font=("Times New Roman", 25), command=lambda: add("2"))
	b2.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b3 = Button(row1, bg=main_bg, fg=main_fg, text='3', font=("Times New Roman", 25), command=lambda: add("3"))
	b3.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	ba = Button(row1, bg=main_bg, fg=main_fg, text='+', font=("Times New Roman", 25), command=lambda: add("+"))
	ba.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	bs = Button(row1, bg=main_bg, fg=main_fg, text='-', font=("Times New Roman", 25), command=lambda: add("-"))
	...
	b4 = Button(row2, bg=main_bg, fg=main_fg, text='4', font=("Times New Roman", 25), command=lambda: add("4"))
	b4.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b5 = Button(row2, bg=main_bg, fg=main_fg, text='5', font=("Times New Roman", 25), command=lambda: add("5"))
	b5.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b6 = Button(row2, bg=main_bg, fg=main_fg, text='6', font=("Times New Roman", 25), command=lambda: add("6"))
	b6.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	bm = Button(row2, bg=main_bg, fg=main_fg, text='*', font=("Times New Roman", 25), command=lambda: add("*"))
	bm.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	bq = Button(row2, bg=main_bg, fg=main_fg, text='/', font=("Times New Roman", 25), command=lambda: add("/"))
	bq.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	row2.pack(fill='both', expand=True)

	be = Button(root, bg=main_bg, fg=main_fg, text='=', font=("Times New Roman", 30), width=8, command=sum_it_all)
	be.pack(side='right', fill='both', anchor='n', padx=pads, pady=pads)

	row3 = Frame(root, bg=main_bg)

	b7 = Button(row3, bg=main_bg, fg=main_fg, text='7', font=("Times New Roman", 25), command=lambda: add("7"))
	b7.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b8 = Button(row3, bg=main_bg, fg=main_fg, text='8', font=("Times New Roman", 25), command=lambda: add("8"))
	b8.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b9 = Button(row3, bg=main_bg, fg=main_fg, text='9', font=("Times New Roman", 25), command=lambda: add("9"))
	...
	bd = Button(row4, bg=main_bg, fg=main_fg, text='.', font=("Times New Roman", 25), command=lambda: add("."))
	bd.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)

	b0 = Button(row4, bg=main_bg, fg=main_fg, text='0', font=("Times New Roman", 25), command=lambda: add("0"))
	b0.pack(side='left', fill='both', expand=True, anchor='n', padx=pads, pady=pads)
	
	bc = Button(row4, bg=main_bg, fg=main_fg, text='CE', font=("Times New Roman", 25), command=delete_one)
