...
def start():
	...
	b1.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b2 = Button(row1, bg=main_bg, fg='#ffffff', text='2', width=5)
	b2.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b3 = Button(row1, bg=main_bg, fg='#ffffff', text='3', width=5)
	b3.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	ba = Button(row1, bg=main_bg, fg='#ffffff', text='+', width=5)
	ba.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	bs = Button(row1, bg=main_bg, fg='#ffffff', text='-', width=5)
	bs.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)
	...
	b4.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b5 = Button(row2, bg=main_bg, fg='#ffffff', text='5', width=5)
	b5.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b6 = Button(row2, bg=main_bg, fg='#ffffff', text='6', width=5)
	b6.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	bm = Button(row2, bg=main_bg, fg='#ffffff', text='*', width=5)
	bm.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)
	...
	be.pack(side='right', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	row3 = Frame(root, bg=main_bg)

	b7 = Button(row3, bg=main_bg, fg='#ffffff', text='7', width=5)
	b7.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b8 = Button(row3, bg=main_bg, fg='#ffffff', text='8', width=5)
	b8.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b9 = Button(row3, bg=main_bg, fg='#ffffff', text='9', width=5)
	b9.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)
	...
	bd.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)

	b0 = Button(row4, bg=main_bg, fg='#ffffff', text='0', width=5)
	b0.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)
	
	bc = Button(row4, bg=main_bg, fg='#ffffff', text='CE', width=5)
	bc.pack(side='left', fill='x', expand=True, anchor='n', padx=pads, pady=pads)
