...
def start():
	...
	be = Button(root, bg='#131320', fg='#ffffff', text='=', width=5, height=10)
	...
	b4 = Button(row2, bg='#131320', fg='#ffffff', text='4', width=5)
	...
	b7 = Button(row3, bg='#131320', fg='#ffffff', text='7', width=5)
	b7.pack(side='left', anchor='n', padx=pads, pady=pads)

	b8 = Button(row3, bg='#131320', fg='#ffffff', text='8', width=5)
	...
	row4 = Frame(root, bg='#131320')

	bq = Button(row4, bg='#131320', fg='#ffffff', text='/', width=5)
	bq.pack(side='left', anchor='n', padx=pads, pady=pads)

	b0 = Button(row4, bg='#131320', fg='#ffffff', text='0', width=5)
	b0.pack(side='left', anchor='n', padx=pads, pady=pads)
	
	bd = Button(row4, bg='#131320', fg='#ffffff', text='.', width=5)
	bd.pack(side='left', anchor='n', padx=pads, pady=pads)
	
	bc = Button(row4, bg='#131320', fg='#ffffff', text='CE', width=5)
